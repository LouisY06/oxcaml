...
(* Standalone Speed Card Game Logic for JavaScript compilation *)
(* This module provides the core game logic that can be compiled to JavaScript *)

module SpeedGame = struct
  (* Card module matching the JavaScript interface *)
  module Card = struct
...
let create_game () = SpeedGame.GameState.create ()
let make_move game_state move = SpeedGame.GameState.make_move game_state move
let get_all_moves game_state = SpeedGame.GameState.get_all_moves game_state
let are_both_players_stuck game_state = SpeedGame.GameState.are_both_players_stuck game_state
let change_middle_cards game_state = SpeedGame.GameState.change_middle_cards game_state
let card_can_play_on card pile_card = SpeedGame.Card.can_play_on card pile_card
let card_to_string card = SpeedGame.Card.to_string card
